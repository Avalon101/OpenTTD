...
INDUSTRY1 <- { 
				...
				BauxiteMine	= {no = 8, dx = 5, dy = 4, ltype = 0, id = 6},
				Biorefinery = {no = 1, dx = 5, dy = 5, ltype = 0, id = 43},
				Brewery = {no = 3, dx = 3, dy = 2, ltype = 2, id = 33},
				BrickWorks = {no = 2, dx = 5, dy = 5, ltype = 0, id = 42},
				BuildersYard = {no = 2, dx = 2, dy = 2, ltype = 2, id = 48},
				CementPlant	= {no = 2, dx = 7, dy = 7, ltype = 0, id = 40},
				ClayPit	= {no = 12, dx = 9, dy = 5, ltype = 0, id = 41},
				CoalMine = {no = 12, dx = 3, dy = 4, ltype = 0, id = 0},
				Dairy = {no = 3, dx = 5, dy = 5, ltype = 2, id = 34},
				DairyFarm = {no = 20, dx = 0, dy = 0, ltype = 0, id = 27},
				DredgingSite = {no = 6, dx = 3, dy = 4, ltype = 1, id = 19},
				...
				Forest = {no = 10, dx = 0, dy = 0, ltype = 0, id = 12},
				FruitPlantation = {no = 20, dx = 0, dy = 0, ltype = 0, id = 29},
				FurnitureFactory = {no = 3, dx = 5, dy = 3, ltype = 2, id = 13},
				GasStation = {no = 2, dx = 0, dy = 0, ltype = 2, id = 47},
				GlassWorks = {no = 3, dx = 4, dy = 4, ltype = 0, id = 21},
				GrainMill = {no = 3, dx = 3, dy = 2, ltype = 2, id = 32},
				HardwareStore = {no = 2, dx = 0, dy = 0, ltype = 3, id = 44},
				Hotel = {no = 2, dx = 2, dy = 2, ltype = 2, id = 45},
				IronOreMine = {no = 10, dx = 4, dy = 4, ltype = 0, id = 18},
				IronWorks = {no = 1, dx = 3, dy = 3, ltype = 0, id = 20},
				JunkYard = {no = 8, dx = 0, dy = 0, ltype = 0, id = 24},
				LimeKiln = {no = 1, dx = 3, dy = 4, ltype = 0, id = 1},
				LumberYard = {no = 1, dx = 5, dy = 5, ltype = 0, id = 38},
				MachineShop = {no = 1, dx = 6, dy = 6, ltype = 0, id = 36},
				MetalFabricationPlant = {no = 3, dx = 3, dy = 5, ltype = 0, id = 3},
				MetalWorkshop = {no = 3, dx = 4, dy = 5, ltype = 0, id = 10},
				MixedFarm = {no = 14, dx = 0, dy = 0, ltype = 0, id = 28},
				...
				Quary = {no = 6, dx = 9, dy = 5, ltype = 0, id = 11},
				RecyclingDepot = {no = 15, dx = 2, dy = 2, ltype = 2, id = 23},
				RecyclingPlant = {no = 4, dx = 3, dy = 2, ltype = 0, id = 22},
				Sawmill = {no = 1, dx = 0, dy = 0, ltype = 0, id = 2},
				SheepFarm = {no = 20, dx = 0, dy = 0, ltype = 0, id = 26},
				...
				TextileMill = {no = 3, dx = 5, dy = 4, ltype = 2, id = 39},
...
INDUSTRY2 <- { 
				...
				MetalWorkshop = {no = 3, dx = 4, dy = 5, ltype = 0, id = 10},
				MixedFarm = {no = 14, dx = 0, dy = 0, ltype = 0, id = 28},
				OilRefinery	= {no = 3, dx = 4, dy = 5, ltype = 0, id = 4},
				OilRig = {no = 5, dx = 11, dy = 11, ltype = 1, id = 5},
				OilWells = {no = 5, dx = 0, dy = 0, ltype = 0, id = 15},
				PaperMill = {no = 3, dx = 0, dy = 0, ltype = 0, id = 14},
				PlasticsPlant = {no = 3, dx = 5, dy = 5, ltype = 0, id = 16},
...
TEST <- { 
				...
				HardwareStore = {no = 3, dx = 0, dy = 0, ltype = 3, id = 44},
				...
				LumberYard = {no = 1, dx = 5, dy = 5, ltype = 0, id = 38},
				MachineShop = {no = 1, dx = 6, dy = 6, ltype = 0, id = 36},
				MetalFabricationPlant = {no = 5, dx = 3, dy = 5, ltype = 0, id = 3},
				MetalWorkshop = {no = 3, dx = 4, dy = 5, ltype = 0, id = 10},
				...
				PaperMill = {no = 3, dx = 0, dy = 0, ltype = 0, id = 14},
				PlasticsPlant = {no = 3, dx = 5, dy = 5, ltype = 0, id = 16},
				Quary = {no = 4, dx = 9, dy = 5, ltype = 0, id = 11},
				RecyclingPlant = {no = 4, dx = 3, dy = 2, ltype = 0, id = 22},*/
				RecyclingDepot = {no = 15, dx = 2, dy = 2, ltype = 2, id = 23},/*
				Sawmill = {no = 1, dx = 0, dy = 0, ltype = 0, id = 2},
				SheepFarm = {no = 12, dx = 0, dy = 0, ltype = 0, id = 26},*/
				SmithyForge = {no = 1, dx = 0, dy = 0, ltype = 3, id = 7},/*
				SteelMill = {no = 1, dx = 4, dy = 4, ltype = 0, id = 8},
				Stockyard = {no = 3, dx = 5, dy = 4, ltype = 2, id = 35},
				SugarRefinery = {no = 4, dx = 4, dy = 3, ltype = 2, id = 17},
...
class Industries
{
	...
	constructor(){
		this.INDUSTRIES = this.Variation();	// Load the industry variation setting.
...
function Industries::TList(type){
	local list = [];
	foreach(i, v in this.INDUSTRIES)
	{
...
function Industries::Variation(){
	switch(GSController.GetSetting("industry_amount_variation")){
		case 1:
			return INDUSTRY1;
			break;
		case 2:
